...
namespace CLR_VIA_C_SHARP._2_Type_Design.Testing
{
    class Testing
    {
        public static void main()
        {
            ...
            // 13 Interfaces
            nsInterfaces.Interfaces testInterfaces = new nsInterfaces.Interfaces();
            testInterfaces.Run();
        }
    }
    ...
    namespace nsInterfaces
    {
        public class Interfaces
        {
            ...
            private void TestInterface2()
            {
                // Компилятор C# требует, чтобы метод, реализующий интерфейс, отмечался модификатором public.
                // CLR требует, чтобы интерфейсные методы были виртуальными.
                // Если метод явно не определен в коде как виртуальный, компилятор сделает его таковым и, вдобавок, запечатанным.
        ...
        internal class MyBase : IComparable
        {
        ...
        internal sealed class MyDerived : MyBase, IComparable
        {
